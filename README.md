...
- Costo vendido = kilos vendidos * costo.
...
- Utilidad minima = ((venta minima * 0.95) - (costo vendido * 0.98)) / 1.19.
- Utilidad objetivo = ((venta objetivo * 0.95) - (costo vendido * 0.98)) / 1.19.
